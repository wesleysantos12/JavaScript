...
console.log("Verificação com && :", cond1 && cond2); // false
console.log("Verificação com || :", cond1 || cond2); // true    
// 21. Use o operador `!` para inverter o valor booleano de uma variável.
console.log("Inversão com ! :", !cond1); // false
console.log("Inversão com ! :", !cond2); // true    
...
console.log("Tipo de número:", typeof numeroExemplo); // number     
// 25. Use o operador `typeof` para verificar o tipo de uma variável booleana.
let booleano = true;
console.log("Tipo de booleano:", typeof booleano); // booleano  
...
console.log("Propriedade 'nome' existe em pessoa:", "nome" in pessoa); // true
...
console.log("pessoa é instância de Object:", pessoa instanceof Object); // true     
...
console.log("Valor padrão:", valorPadrao); // "Valor Padrão"
console.log("Expressão complexa:", (num1 + num2 > 10 && num 1 < 20) || (num2 === 10)); // true